...
class CoordinadorTest {
    ...
    @Test
@DisplayName("Validación de título inválido - no debe guardar")
void testValidacionTituloInvalido() {
    ...
    @Test
    @DisplayName("Validación sin estudiantes - no debe guardar")
    void testValidacionSinEstudiantes() {
